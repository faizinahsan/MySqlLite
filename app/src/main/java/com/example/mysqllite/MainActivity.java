...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, LoadNotesCallback {
    ...
    private static class LoadNotesAsync extends AsyncTask<Void,Void,ArrayList<Note>>{
        ...
        private final WeakReference<LoadNotesCallback> weaakCallback;
        private LoadNotesAsync(NoteHelper noteHelper, LoadNotesCallback callback){
            weakNoteHelper = new WeakReference<>(noteHelper);
            weaakCallback = new WeakReference<>(callback);
        }

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            weaakCallback.get().preExecute();
        }
        ...
        protected void onPostExecute(ArrayList<Note> notes) {
            ...
            weaakCallback.get().postExecute(notes);
        }
    }
