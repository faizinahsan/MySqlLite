...
import com.example.mysqllite.db.NoteHelper;
...
Masih ingat materi di mana sebuah Activity menjalankan Activity lain dan menerima nilai balik pada metode onActivityResult()? Tepatnya di Activity yang dijalankan dan ditutup dengan menggunakan parameter REQUEST dan RESULTCODE. Jika Anda lupa, baca kembali baca modul 1 tentang Intent ya.
* */
...
//            boolean isEdit untuk membaca apakah ini pembuatan data baru atau data yang sudah ada
            if (isEdit){
...
//    showAlertDialog untuk memunculkan dialognya
